        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    article_image = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "文章呈现图"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArticleForeignKey = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_evaluation_article_CategoryTypeId",
                table: "evaluation_article",
                column: "CategoryTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_evaluation_comment_ArticleForeignKey",

        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    is_deleted = table.Column<bool>(type: "tinyint(1)", nullable: true, comment: "逻辑删除"),
                    is_reply = table.Column<bool>(type: "tinyint(1)", nullable: true, comment: "该评论是否为回复"),
                    reply_comment_id = table.Column<int>(type: "int", nullable: true, comment: "回复的评论id"),
                    reply_userid = table.Column<string>(type: "varchar(450)", maxLength: 450, nullable: true, comment: "回复的玩家Id")
                        .Annotation("MySql:CharSet", "utf8mb4"),
